 ...
 * @author joel010
 */
public class PlaneView extends javax.swing.JInternalFrame {
     ...
     * @throws IOException
     */
    public PlaneView() throws IOException {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            plane = (Plane) _Utility.intanceObject(Plane.class, map);
            _controller.create(plane);
            ...
            Logger.getLogger(PlaneView.class.getName()).log(Level.SEVERE, null, e);

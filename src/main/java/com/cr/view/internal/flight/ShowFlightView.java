...
public class ShowFlightView extends javax.swing.JInternalFrame {
    ...
    // private CustomTableModel<Flight> dataModel;
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtSearchKeyReleased
        System.out.println(txtSearch.getText().toUpperCase());
        filter(txtSearch.getText().toUpperCase());
    ...
    private void setTableModel() {
        model = new CustomTableModel<Flight>(_controller.getAll(),
                new String[] { "ID", "Name", "Code", "Source", "Dest.", "Date" });
        tbFlight.setModel(model);
    }

    private void filter(String query) {
        var tr = new TableRowSorter<CustomTableModel>(model);
        tr.setRowFilter(RowFilter.regexFilter(query));
        tbFlight.setRowSorter(tr);
